...
class LinkedList {
    ...
    // Check if the list contains a song by title
    contains(songTitle) {
        let current = this.head;
        while (current) {
            if (current.song.title === songTitle) {
        ...
        deleteBtn.addEventListener('click', async function(e) {
            ...
            try {
                ...
                if (window.songs[currentSongIndex] && window.songs[currentSongIndex].id === song.id) {
                    ...
                    document.getElementById('current-album-art').src = 'images/Audiva Logo.png';
...
// Update progress bar and light violet line
